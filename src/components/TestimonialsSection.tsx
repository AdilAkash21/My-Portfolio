...
// Displays testimonial cards with quote, name, role, and avatar.
// Batman mode: testimonials from Gotham characters.
...
const normalTestimonials: Testimonial[] = [
  {
...
const batmanTestimonials: Testimonial[] = [
  {
