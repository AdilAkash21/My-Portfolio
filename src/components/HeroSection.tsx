...
const BAT_CLIP = "polygon(50% 10%, 45% 0%, 38% 14%, 30% 5%, 22% 18%, 10% 20%, 0% 38%, 8% 50%, 0% 62%, 15% 70%, 25% 85%, 35% 75%, 42% 90%, 50% 80%, 58% 90%, 65% 75%, 75% 85%, 85% 70%, 100% 62%, 92% 50%, 100% 38%, 90% 20%, 78% 18%, 70% 5%, 62% 14%, 55% 0%)";
