...
const BAT_CLIP = "polygon(50% 5%, 46% 0%, 42% 12%, 38% 8%, 34% 18%, 28% 15%, 18% 25%, 8% 30%, 0% 45%, 5% 52%, 12% 55%, 20% 60%, 15% 68%, 22% 72%, 30% 80%, 35% 88%, 42% 78%, 48% 95%, 50% 100%, 52% 95%, 58% 78%, 65% 88%, 70% 80%, 78% 72%, 85% 68%, 80% 60%, 88% 55%, 95% 52%, 100% 45%, 92% 30%, 82% 25%, 72% 15%, 66% 18%, 62% 8%, 58% 12%, 54% 0%)";
