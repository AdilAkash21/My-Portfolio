...
const ExperienceSection = () => {
  ...
  return (
    <section id="experience" className="relative py-28 overflow-hidden">
      ...
      {/* Soft ambient glow */}
      <div className="absolute -left-40 top-1/3 h-[420px] w-[420px] rounded-full bg-primary/[0.05] blur-[140px] pointer-events-none" />
            ...
            {timeline.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <motion.div
                      className="group rounded-2xl border border-border/70 bg-card/40 backdrop-blur-sm p-6 cursor-pointer select-none hover:border-primary/40 hover:bg-card/60 transition-all duration-300"
