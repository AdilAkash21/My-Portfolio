      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-14 max-w-6xl mx-auto items-start">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-4">
              {facts.map((f) => (
                <div
                  key={f.label}
                  className="hover-box rounded-2xl border border-border/70 bg-card/40 backdrop-blur-sm p-5"
                >
          ...
          <motion.div
            ...
            className="hover-box relative rounded-[1.75rem] border border-primary/15 bg-primary/[0.02] p-6 sm:p-8"
          >
