...
// Displays animated skill progress rings and service cards.
// In batman mode: shows combat abilities and vigilante services.
...
const ProgressRing = ({ name, level, index }: { name: string; level: number; index: number }) => {
